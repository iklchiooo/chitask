...
var _STRINGS = {
  id: {
    ...
    // ── Add bar ──
    placeholder_task: 'Tambah task... cth: "beli susu besok jam 8"',
    placeholder_task_mobile: 'Nama task... cth: "besok jam 8 beli susu"',
    btn_add_task: '+ Tambah',
    ...
    // ── Sync / save ──
    saved: '✓ Tersimpan',
    sync_activate: '☁️ Aktifkan sync → Maszuk denganss Googlezssss',
